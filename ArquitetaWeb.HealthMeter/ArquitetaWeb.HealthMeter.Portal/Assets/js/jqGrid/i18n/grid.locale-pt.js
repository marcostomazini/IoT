...
$.extend($.jgrid,{
	...
	search : {
	    ...
	    Find: "Procurar",
	    Reset: "Limpar",
	    odata: [{ oper:'eq', text:'igual'},{ oper:'ne', text:'diferente'},{ oper:'lt', text:'menor'},{ oper:'le', text:'menor ou igual'},{ oper:'gt', text:'maior'},{ oper:'ge', text:'maior ou igual'},{ oper:'bw', text:'comece com..'},{ oper:'bn', text:'não comece com...'},{ oper:'in', text:'contenha'},{ oper:'ni', text:'que não contenha'},{ oper:'ew', text:'termine com...'},{ oper:'en', text:'não termine com...'},{ oper:'cn', text:'que contém'},{ oper:'nc', text:'não contém'}],
